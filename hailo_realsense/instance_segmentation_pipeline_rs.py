...
from gstreamer_helper_pipelines_rs import (SOURCE_PIPELINE, DEPTH_PIPELINE)
...
class GStreamerInstanceSegmentationApp(GStreamerApp):
    def __init__(self, app_callback, depth_callback, user_data, parser=None):
        if parser == None:
    ...
    def get_pipeline_string(self):
        ...
        depth_pipeline = DEPTH_PIPELINE(video_source=self.video_source, video_width=self.video_width, video_height=self.video_height)
